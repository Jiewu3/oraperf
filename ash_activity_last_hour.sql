...
REM Fixed AAS computation for last interval
REM ***************************************************************************

SET TERMOUT ON LINESIZE 110 SCAN ON VERIFY OFF FEEDBACK OFF
...
PROMPT
prompt &_C_YELLOW in ash_activity_last_hour.sql &_C_RESET
accept _sid PROMPT "&_C_RED Enter session_id [default all]: &_C_RESET" default all
accept _sql_id PROMPT "&_C_RED Enter sql_id [default all]: &_C_RESET" default all
