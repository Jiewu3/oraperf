SET ECHO OFF
REM Description.: Display top modules for the period specified as parameter.
...
PROMPT
prompt &_C_YELLOW in ash_top_modules.sql &_C_RESET
...
COLUMN service FORMAT A30 TRUNCATE HEADING "Service"
COLUMN module FORMAT A40 TRUNCATE HEADING "Module"
