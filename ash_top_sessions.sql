SET ECHO OFF
REM Description.: Display top sessions for the period specified as parameter.
...
SET TERMOUT ON LINESIZE 300 SCAN ON VERIFY OFF FEEDBACK OFF
...
PROMPT
prompt &_C_YELLOW in ash_top_sessions.sql &_C_RESET
...
COLUMN session_serial# FORMAT 999999999 HEADING "Ses Serial"
